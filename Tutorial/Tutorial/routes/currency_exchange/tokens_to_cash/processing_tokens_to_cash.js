...
var contractAddress = '0xaff5fb89c81f9b5566d49347e4880e3cf4a7e21c';//Token�X����}
    ...
    pool.getConnection(function (err, connection) {
        connection.query('SELECT * FROM user_info WHERE user_id = ?', [req.session.user_id], function (err, rows) {
            if (err) {
                ...
                var wallet_address = rows[0].user_wallet_address; //����XToken�����]
                var total_exchange = req.body.num_cash;//�I���ƶq(�ȮɥH�I�X���B���N,�]��1:1)
                var total_exchange = total_exchange * Math.pow(10, 18);//Token decimal=18
                //var count = web3.eth.getTransactionCount(token_wallet);//�o�����]��}
                ...
                var count = web3.eth.getTransactionCount(token_wallet);//�o�����]��} count�����~�� ���M�s�����⦸�|��(�~�����|��s)
                ...
                var rawTransaction = {
                    ...
                    "to": contractAddress,
                    "value": "0x0",
                    "data": contract.transferPreSigned.getData(sign, to, val, fee, nonce)//��100�TToken
                };
